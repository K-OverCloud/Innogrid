    ...
    $.widget("selectBox.selectBoxIt", {
        ...
        _replaceSelectBox: function() {
            ...
            if(self.options["autoWidth"]) {
                ...
                if(self.originalElem.style.width != "")
                {   
                    self.dropdown.css("width", self.originalElem.style.width);

                    if(self.originalElem.style.width.indexOf('%') > 0)
                    {
                        self.list.css({
                            "min-width":self.originalElem.style.width
                        });
                    }
                    else
                    {
                        self.list.css({
                            "min-width": (self.dropdown.width() + 12) + "px"
                        });
                    }
